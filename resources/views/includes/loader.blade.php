...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // 🔹 Réaffiche le loader sur tous les clics de lien (cards incluses)
    ...
    window.addEventListener("pageshow", (event) => {
        // Si la page vient du cache du navigateur
        if (event.persisted) {
            loader.classList.add("hide");
        }
    });

    // 🔹 Affiche un petit fade-in même quand on revient d’un lien
