...
<body>
    ...
    <div class="container">
        ...
        @csrf
            <input class="input" type="text" name="username" required placeholder="Nom d'utilisateur" id="email"><br><br>

               
            <input type="password" id="password" name="password" class="input" required placeholder="Mot de passe" id="password">
