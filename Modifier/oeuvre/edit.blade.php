...
<div id="addForm" style="margin-bottom: 20px; padding:10px; border:1px solid #ccc; border-radius:5px; background:#f9f9f9;">
    ...
    <input type="date" name="date_depot" value="{{ $oeuvre->date_depot }}" required>
    <label for="">Code titre:</label>
    <input type="text" name="code_titre" value="{{ $oeuvre->code_titre }}" required>
    <label for="">Titre: </label>
    <input type="text" name="titre" value="{{ $oeuvre->titre }}" required>
    <label for="">Catégorie: </label>
    <input type="text" name="categories" value="{{ $oeuvre->categorie }}" required>
    <label for="">Numéro OMDA:</label>
    <input type="text" name="num" value="{{ $oeuvre->num }}" required>
    <label for="">Nom: </label>
    <input type="text" name="nom" value="{{ $oeuvre->nom }}" required> 
    <label for="">Pseudo:</label>
    <input type="text" name="pseudo" value="{{ $oeuvre->pseudo }}" required>
    <label for="">Groupes:</label>
    <input type="text" name="groupes" value="{{ $oeuvre->groupes }}" required>
    <label for="">Qualité: </label>
    <input type="text" name="qualite" value="{{ $oeuvre->qualite }}" required>
    <label for="">Droit: </label>
    <input type="text" name="droit" value="{{ $oeuvre->droit }}" required>
    <label for="">Part:</label>
    <input type="text" name="part" value="{{ $oeuvre->part }}" required>
    <label for="">Hologramme:</label>
    <input type="text" name="hologramme" value="{{ $oeuvre->hologramme }}" required>
    <button type="submit" class="btn btn-save">Modifier l'oeuvre</button><br>
...
<div id="addForm" style="margin-bottom: 20px; padding:10px; border:1px solid #ccc; border-radius:5px; background:#f9f9f9;">
    ...
    <input type="text" name="titre" value="{{ $oeuvre->titre }}" required>
    <label for="">Catégorie: </label>
    <input type="text" name="categories" value="{{ $oeuvre->categories }}" required>
    <label for="">Numéro OMDA:</label>
    <input type="text" name="num" value="{{ $oeuvre->num }}" required>
    <label for="">Auteur:</label>
    <input type="text" name="auteur" value="{{$oeuvre->auteur }}" required>
    <label for="">Part:</label>
    <input type="text" name="part" value="{{ $oeuvre->part }}" required >
    <button type="submit" class="btn btn-save">Modifier l'oeuvre</button><br>
    <a href="{{ route('oeuvres.index') }}" class="btn btn-cancel">Annuler</a>
